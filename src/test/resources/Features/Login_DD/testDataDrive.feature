Feature: Test datatable using poi
  ...
  #Given Get the test data alone "src/test/resources/Data/personData.xlsx"
  @Dataex
  Scenario Outline: Verify my Ex login
    # add a step to provide test data xls and sheet name
    Given Get the test data alone "src/test/resources/Data/personData.xlsx" "Sheet1" "<Testcase>"
