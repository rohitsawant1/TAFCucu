...
@CucumberOptions(features = {"src/test/resources/Features/Login", "src/test/resources/Features/Login_DD"}
					, glue = {"Web.StepDefLogin", "Web.StepDefLogin_DD"}
					, plugin = {"pretty", "html:target/reports/test-output", "json:json_output/cucumber.json", "junit:junit_xml/cucumber.xml"}
					, monochrome = true
					, strict = true
					, dryRun = false
					, tags = {"@Dataex"}//,@SanityTest"} //<- All Sanity
